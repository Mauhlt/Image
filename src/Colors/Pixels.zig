...
//             .gray => .{ .gray = try .initEmpty(gpa, n_pixels) },
...
//             .{ .rgb = try .init(gpa, data, @enumFromInt(@intFromEnum(data_order))) },
